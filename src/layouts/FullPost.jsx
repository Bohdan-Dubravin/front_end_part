...
const FullPost = () => {
  ...
  return (
    <Box className="mb-[30px] bg-white px-[20px] flex-col relative">
      <Typography variant="h4" className="my-[20px] truncate">
        {title}
      </Typography>
      <Box className="rounded border">
        <img
          className="w-[100%] h-[330px] mb-[5px] object-contain object-center  mobile:h-[200px]"
          src={image}
          alt="item-img"
        />
      </Box>
      <Box className="flex flex-col px-[10px] border mt-[10px] rounded">
      ...
      <Box className=" absolute top-[310px] left-[30px] bg-slate-50 rounded p-1">
        <Avatar
          size="sm"
      ...
      <Box
        className="my-[10px] bg-[#fcfafa] p-1 rounded"
